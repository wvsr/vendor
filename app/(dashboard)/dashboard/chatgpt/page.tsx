...
import Cube from '@/public/dashboard/cube.png'
function Dashboard() {
  return (
    <main>
      ...
      <div className='grid grid-cols-12'>
        ...
        <div className='col-span-8 px-3 py-2 bg-[#252525] flex flex-col justify-between items-center'>
          <div></div>
          <div className='space-y-3 flex justify-center items-center flex-col'>
            <div className='w-fit bg-white rounded-full px-1 py-2'>
              <Image alt='Cube' src={Cube} />
            </div>
            <p className='text-xl font-semibold text-[#999999]'>
              Al Expert with latest Al insights
            </p>
          </div>
          <div className='w-full space-y-2'>
            <div className='grid grid-cols-2 gap-2 w-full'>
              <div
                className='bg-[#2B2B2B] rounded-xl border border-[#565869] px-3 py-2 w-full'
                role='button'
              >
                <p className='font-semibold text-sm'>Write a thank-you note</p>
                <p className='opacity-70 text-sm'>to my interviewer</p>
              </div>
              <div
                className='bg-[#2B2B2B] rounded-xl border border-[#565869] px-3 py-2 w-full'
                role='button'
              >
                ...
                <p className='opacity-70 text-sm'>in novels and in films</p>
              </div>
              <div
                className='bg-[#2B2B2B] rounded-xl border border-[#565869] px-3 py-2 w-full'
                role='button'
              >
                <p className='font-semibold text-sm'>Come up with concepts</p>
              ...
              <div
                ...
                role='button'
              >
                <p className='font-semibold text-sm'>Plan an itinerary</p>
                <p className='opacity-70 text-sm'>
                  to experience the wildlife in the Australian outback
                </p>
              </div>
            </div>
            <div className='w-full px-2 py-2 rounded-xl border border-[#8E8EA0] flex gap-2'>
              <input
                type='text'
                className='placeholder:text-[#FFFFFF80] bg-transparent placeholder:text-sm outline-none w-full'
                placeholder='Message AL Guide…'
              />
              <button className='w-fit px-1 py-1 bg-[#404040] rounded-md outline-none'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='24'
                  height='24'
